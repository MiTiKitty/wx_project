...
const BaseUrl = "http://localhost:14041/"
...
* 供外部put请求调用
*/
function put(url, params, onSuccess, onFailed, useToken) {
  // console.log("请求方式：", "PUT");
  request(url, params, "PUT", onSuccess, onFailed, useToken);
}

/**
* 供外部delete请求调用
*/
function del(url, params, onSuccess, onFailed, useToken) {
  // console.log("请求方式：", "DELETE");
  request(url, params, "DELETE", onSuccess, onFailed, useToken);
}
